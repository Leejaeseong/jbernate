...
public class Crud11Test {
	...
	public void crud1n1TableTest() {
		...
		// Master 추가된 데이터 get ////////////////////////////////////////////////////////////////////		
		master = (Tt11Master)cService.get( null, new Tt11Master( seq ) );
		...
		List<Tt11Slave1> list = cService.list( null, slave1, BeanUtil.oneWhere( "seq.seq", seq, WhereBean.Clause.EQ ) );
		...
		slave1 = (Tt11Slave1)cService.get( null, new Tt11Slave1( new Tt11Master( 4L ) ) );
