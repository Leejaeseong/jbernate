...
@Entity( name = "com.jbernate.mundi.domain.table.PerYearMgr" )
@Table( name = "PER_YEAR_MGR" )
@SequenceGenerator( name = "PER_YEAR_MGR_S", sequenceName = "PER_YEAR_MGR_S",  initialValue = 1, allocationSize = 1 )
public class PerYearMgr implements Serializable{
	private static final long serialVersionUID = 1L;

	public PerYearMgr(){};
	public PerYearMgr( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "PER_YEAR_MGR_S" )
