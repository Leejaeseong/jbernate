...
@Entity( name = "com.jbernate.mundi.domain.table.GoalMgrExlTmp" )
@Table( name = "GOAL_MGR_EXL_TMP" )
@SequenceGenerator( name = "GOAL_MGR_EXL_TMP_S", sequenceName = "GOAL_MGR_EXL_TMP_S",  initialValue = 1, allocationSize = 1 )
public class GoalMgrExlTmp implements Serializable{
	private static final long serialVersionUID = 1L;

	public GoalMgrExlTmp(){};
	public GoalMgrExlTmp( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "GOAL_MGR_EXL_TMP_S" )
	...
	//
	@Column( name = "TEAM_SEQ", precision = 16, scale = 0, nullable = false ) 
	...
	//
	@Column( name = "USER_SEQ", precision = 16, scale = 0, nullable = false ) 
	...
	//
	@Column( name = "HOSPT_SEQ", precision = 16, scale = 0, nullable = false ) 
