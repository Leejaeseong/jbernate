...
@Entity( name = "com.jbernate.mundi.domain.table.LogModHistory" )
@Table( name = "LOG_MOD_HISTORY" )
@SequenceGenerator( name = "LOG_MOD_HISTORY_S", sequenceName = "LOG_MOD_HISTORY_S",  initialValue = 1, allocationSize = 1 )
public class LogModHistory implements Serializable{
	private static final long serialVersionUID = 1L;

	public LogModHistory(){};
	public LogModHistory( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "LOG_MOD_HISTORY_S" )
