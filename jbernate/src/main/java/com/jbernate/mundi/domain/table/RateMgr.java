...
@Entity( name = "com.jbernate.mundi.domain.table.RateMgr" )
@Table( name = "RATE_MGR" )
@SequenceGenerator( name = "RATE_MGR_S", sequenceName = "RATE_MGR_S",  initialValue = 1, allocationSize = 1 )
public class RateMgr implements Serializable{
	private static final long serialVersionUID = 1L;

	public RateMgr(){};
	public RateMgr( BigDecimal seq ){	this.seq = seq;	}

	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "RATE_MGR_S" )
