...
@Entity( name = "com.jbernate.mundi.domain.table.PerYearMgrExlTmp" )
@Table( name = "PER_YEAR_MGR_EXL_TMP" )
@SequenceGenerator( name = "PER_YEAR_MGR_EXL_TMP_S", sequenceName = "PER_YEAR_MGR_EXL_TMP_S",  initialValue = 1, allocationSize = 1 )
public class PerYearMgrExlTmp implements Serializable{
	private static final long serialVersionUID = 1L;

	public PerYearMgrExlTmp(){};
	public PerYearMgrExlTmp( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "PER_YEAR_MGR_EXL_TMP_S" )
