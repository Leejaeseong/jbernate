...
public class LoggerUtil {
	...
	public static void print( Object msg ) {	LoggerUtil util = new LoggerUtil();	Logger logger = util.getLogger();	if( logger != null ) System.out.print( preMsg + msg );				}
	public static void println( Object msg ) {	LoggerUtil util = new LoggerUtil();	Logger logger = util.getLogger();	if( logger != null ) System.out.println( preMsg + msg );			}
