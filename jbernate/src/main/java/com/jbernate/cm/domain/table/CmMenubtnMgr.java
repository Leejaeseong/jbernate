...
@Entity( name = "com.jbernate.cm.domain.table.CmMenubtnMgr" )
@Table( name = "CM_MENUBTN_MGR" )
@SequenceGenerator( name = "CM_MENUBTN_MGR_S", sequenceName = "CM_MENUBTN_MGR_S",  initialValue = 1, allocationSize = 1 )
public class CmMenubtnMgr implements Serializable{
	private static final long serialVersionUID = 1L;

	public CmMenubtnMgr(){};
	public CmMenubtnMgr( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "CM_MENUBTN_MGR_S" )
	...
	//
	@Column( name = "BTN_NM", length = 128, nullable = true ) 
	private String btnNm;
	public String getBtnNm() {	return btnNm;	}
	public void setBtnNm(String btnNm) {	this.btnNm = btnNm;	}
