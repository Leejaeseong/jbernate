...
@Entity( name = "com.jbernate.cm.domain.table.CmRolegrpmenubtnMap" )
@Table( name = "CM_ROLEGRPMENUBTN_MAP" )
@SequenceGenerator( name = "CM_ROLEGRPMENUBTN_MAP_S", sequenceName = "CM_ROLEGRPMENUBTN_MAP_S",  initialValue = 1, allocationSize = 1 )
public class CmRolegrpmenubtnMap implements Serializable{
	private static final long serialVersionUID = 1L;

	public CmRolegrpmenubtnMap(){};
	public CmRolegrpmenubtnMap( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "CM_ROLEGRPMENUBTN_MAP_S" )
	...
	//
	@ManyToOne
	@JoinColumn( name = "ROLEGRPMENUMAP_SEQ", referencedColumnName = "SEQ", columnDefinition = "NUMBER(16) NOT NULL UNIQUE" )
	private CmRolegrpmenuMap rolegrpmenumapSeq;
	public CmRolegrpmenuMap getRolegrpmenumapSeq() {	return rolegrpmenumapSeq;	}
	public void setRolegrpmenumapSeq(CmRolegrpmenuMap rolegrpmenumapSeq) {	this.rolegrpmenumapSeq = rolegrpmenumapSeq;	}
