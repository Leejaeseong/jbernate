...
@Entity( name = "com.jbernate.cm.domain.table.CmRolegrpmenuMap" )
@Table( name = "CM_ROLEGRPMENU_MAP" )
@SequenceGenerator( name = "CM_ROLEGRPMENU_MAP_S", sequenceName = "CM_ROLEGRPMENU_MAP_S",  initialValue = 1, allocationSize = 1 )
public class CmRolegrpmenuMap implements Serializable{
	private static final long serialVersionUID = 1L;

	public CmRolegrpmenuMap(){};
	public CmRolegrpmenuMap( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "CM_ROLEGRPMENU_MAP_S" )
