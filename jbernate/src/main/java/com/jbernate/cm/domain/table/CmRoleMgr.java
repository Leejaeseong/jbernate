...
@Entity( name = "com.jbernate.cm.domain.table.CmRoleMgr" )
@Table( name = "CM_ROLE_MGR" )
@SequenceGenerator( name = "CM_ROLE_MGR_S", initialValue = 1, allocationSize = 1 )
public class CmRoleMgr implements Serializable{
	private static final long serialVersionUID = 1L;

	public CmRoleMgr(){};
	public CmRoleMgr( BigDecimal seq ){	this.seq = seq;	}
	...
	//Sequence
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "CM_ROLE_MGR_S" )
	...
	//null
	@Column( name = "ROLE_NM", length = 256, nullable = true ) 
