	...
	$scope.onFileSelect = function($files) {
		...
		for (var i = 0; i < $files.length; i++) {
			...
			$scope.upload = $upload.upload({
				url : 'server/upload/url', // upload.php
											// script, node.js
											// route, or servlet
											// url
				// method: 'POST' or 'PUT',
				...
				file : file, // or list of files ($files) for
								// html5 only
			// fileName: 'doc.jpg' or ['1.jpg', '2.jpg', ...] //
			// to modify the name of the file(s)
			// customize file formData name
			// ('Content-Desposition'), server side file
			// variable name.
			// fileFormDataName: myFile, //or a list of names
			// for multiple files (html5). Default is 'file'
		 ...
		 // alternative way of uploading, send the file binary
		 // with the file's content-type. Could be used to upload
		 // files to CouchDB, imgur, etc... html5 FileReader is
		 // needed. It could also be used to monitor the progress
		 // of a normal http post/put request with large data
